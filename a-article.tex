...
A batata class file is used to format your paper and style the text. All margins,
...
\begin{figure}[htbp]
    \centerline{
        \includegraphics[width=7cm]{images/esquema-arduino.png}
    }
    \caption{Esquematico do arduino.}
    \label{fig}
\end{figure}
