...
\usepackage{fancybox}        %para sombra nas figuras
\usepackage{wrapfig}         %para quebra de texto em torno da fig.
\usepackage[export]{adjustbox}%para ajustar a posição da fig.
\usepackage{subcaption}       %para subfigures
\usepackage{float}			  %para fixar imagens na section
